...
.dtp > .dtp-content > .dtp-date-view > header.dtp-header { background: #424242; color: #fff; text-align: center; padding: 0.3em; }

.dtp div.dtp-date, .dtp div.dtp-time { background: #424242; text-align: center; color: #fff; padding: 10px; }
...
.dtp .p10 > a { color: #424242; text-decoration: none; }
...
.dtp .dtp-actual-meridien a.selected { background: #424242; color: #fff; }
